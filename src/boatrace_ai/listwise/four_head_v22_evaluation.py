...
def run_v22_smoke_evaluation(
    ...
    *,
    ...
    return {
        ...
        "evaluation_days": formal_bankroll["evaluation_days"],
        "tickets": formal_bankroll["tickets"],
        "hit_tickets": formal_bankroll["hit_tickets"],
        "winning_days": formal_bankroll["winning_days"],
        "profitable_day_fraction": formal_bankroll["profitable_day_fraction"],
        "roi_without_largest_hit": formal_bankroll["roi_without_largest_hit"],
        "largest_hit_return_share": formal_bankroll["largest_hit_return_share"],
        "effective_hit_count": formal_bankroll["effective_hit_count"],
        "daily_cluster_bootstrap_roi_lower_95": formal_bankroll[
            "daily_cluster_bootstrap_roi_lower_95"
        ],
        "promotion_gate": formal_bankroll["promotion_gate"],
        "promotion_eligible": formal_bankroll["promotion_eligible"],
