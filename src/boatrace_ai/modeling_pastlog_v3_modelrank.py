...
from .features_pastlog_v3 import prediction_features
from .modeling import _normalize_lane_probs, trifecta_predictions
from .modeling_pastlog_v3 import FEATURE_SET, positive_probs
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Store past-log v3 predictions ranked by model probability.")
    parser.add_argument("--db", default="data/boatrace.sqlite")
    parser.add_argument("--model", default="data/models/win_model_pastlog_v3.joblib")
