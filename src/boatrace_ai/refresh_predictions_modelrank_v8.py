...
from .modeling_no_odds_v8_modelrank import predict_race


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Refresh all day v8 predictions ranked by model probability.")
