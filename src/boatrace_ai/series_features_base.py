...
from .contextual_features import RollingState, _history_groups_before, _race_context_features, _race_sort_key, load_race_entries
...
def load_training_examples(
    ...
    *,
    ...
    if include_odds:
        raise ValueError("series_features_base does not use odds")
