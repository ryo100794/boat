...
from .features_no_odds_v3 import prediction_features
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Store no-odds v7 predictions ranked by model probability.")
