...
from .modeling_no_odds_v7 import FEATURE_SET, make_pipeline, positive_probs


def configure_v7_bankroll() -> None:
    base.load_training_examples = load_training_examples
    base._make_pipeline = make_pipeline
    base._positive_probs = positive_probs


def bankroll_backtest_v7(
    conn,
    *,
    output_path: Path,
    ...
    result["model"] = "win_model_no_odds_v7"
    result["policy"]["model"] = "win_model_no_odds_v7"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Backtest daily bankroll buying with no-odds v7 model.")
    parser.add_argument("--db", default="data/boatrace.sqlite")
    parser.add_argument("--output", default="data/models/bankroll_backtest_no_odds_v7_10000.json")
