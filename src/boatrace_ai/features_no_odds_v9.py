...
def load_training_examples(
    ...
    *,
    ...
    if include_odds:
        raise ValueError("features_no_odds_v9 is intentionally no-odds for leakage-safe backtesting")
...
def prediction_features(
    ...
    *,
    ...
    if include_odds:
        raise ValueError("features_no_odds_v9 is intentionally no-odds")
