...
from .modeling_realtime_hybrid_v1 import predict_open_races


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Periodic realtime hybrid shadow prediction writer.")
    parser.add_argument("--db", default="data/boatrace.sqlite")
    parser.add_argument("--model", default="data/models/win_model_realtime_hybrid_v1.joblib")
    parser.add_argument("--date", default=date.today().isoformat())
    parser.add_argument("--output", default="data/models/shadow_realtime_hybrid_latest.json")
