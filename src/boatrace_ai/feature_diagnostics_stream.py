...
from .base_features import _latest_beforeinfo, before_features, race_relative_features
from .historical_model import FEATURE_SET
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default="data/models/feature_diagnostics_stream.json")
