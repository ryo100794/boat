        ...
        jobs.append(
            {
                ...
                "joint_product_identity_residual_mean": _float_or_none(
                    metrics.get("joint_product_identity_residual_mean")
                ),
                "joint_product_identity_residual_max_abs": _float_or_none(
                    metrics.get("joint_product_identity_residual_max_abs")
                ),
                "joint_product_identity_consistent": metrics.get(
                ...
                "required_candidates": metrics.get("required_candidates"),
                "prior_candidate_days": metrics.get("prior_candidate_days"),
                "required_candidate_days": metrics.get("required_candidate_days"),
                "calibration_cutoff_time": metrics.get("calibration_cutoff_time"),
                ...
                "calibrated_ROI": metrics.get("calibrated_ROI"),
                "calibrated_ROI_LCB95": metrics.get("calibrated_ROI_LCB95"),
                "buy_threshold": metrics.get("buy_threshold"),
                "approved": metrics.get("approved"),
                "denied": metrics.get("denied"),
                "denial_reason": metrics.get("denial_reason"),
                "calibrator_hash": metrics.get("calibrator_hash"),
                "calibration_ledger_hash": metrics.get("calibration_ledger_hash"),
                "decision_model_sha256": metrics.get("decision_model_sha256"),
                "decision_threshold_sha256": metrics.get("decision_threshold_sha256"),
                "decision_settlement_engine_sha256": metrics.get("decision_settlement_engine_sha256"),
                "decision_hash_bundle_sha256": metrics.get("decision_hash_bundle_sha256"),
                "roi_status": metrics.get("roi_status"),
                "roi_not_applicable_reason": metrics.get("roi_not_applicable_reason"),
                "calibration_local_support_purchase_violations": metrics.get("calibration_local_support_purchase_violations"),
                "calibration_local_support_all_failures_rejected": metrics.get("calibration_local_support_all_failures_rejected"),
                "calibrator_decision_hashes_present": metrics.get("calibrator_decision_hashes_present"),
                "calibrator_decision_hash_bundle_violations": metrics.get("calibrator_decision_hash_bundle_violations"),
                "calibrator_decision_event_binding_violations": metrics.get("calibrator_decision_event_binding_violations"),
                "calibrator_fixed_component_hash_violations": metrics.get("calibrator_fixed_component_hash_violations"),
                "calibrator_duplicate_decision_event_bindings": metrics.get("calibrator_duplicate_decision_event_bindings"),
        ...
        candidates.append(
            {
                ...
                "joint_product_identity_residual_mean": _float_or_none(
                    candidate_metrics.get("joint_product_identity_residual_mean")
                ),
                "joint_product_identity_residual_max_abs": _float_or_none(
                    candidate_metrics.get("joint_product_identity_residual_max_abs")
                ),
                "joint_product_identity_consistent": candidate_metrics.get(
                    "joint_product_identity_consistent"
                ),
                "joint_covariance_mean": _float_or_none(
                ...
                "warmup_days": candidate_metrics.get("warmup_days"),
                "required_days": candidate_metrics.get("required_days"),
                "prior_candidates": candidate_metrics.get("prior_candidates"),
                "required_candidates": candidate_metrics.get("required_candidates"),
                "prior_candidate_days": candidate_metrics.get("prior_candidate_days"),
                "required_candidate_days": candidate_metrics.get("required_candidate_days"),
                "calibration_cutoff_time": candidate_metrics.get("calibration_cutoff_time"),
                "max_training_settlement_time": candidate_metrics.get("max_training_settlement_time"),
                "strict_prior_check": candidate_metrics.get("strict_prior_check"),
                "isotonic_block_count": candidate_metrics.get("isotonic_block_count"),
                ...
                "calibrated_ROI": candidate_metrics.get("calibrated_ROI"),
                "calibrated_ROI_LCB95": candidate_metrics.get("calibrated_ROI_LCB95"),
                "buy_threshold": candidate_metrics.get("buy_threshold"),
                "approved": candidate_metrics.get("approved"),
                "denied": candidate_metrics.get("denied"),
                "denial_reason": candidate_metrics.get("denial_reason"),
                "calibrator_hash": candidate_metrics.get("calibrator_hash"),
                "calibration_ledger_hash": candidate_metrics.get("calibration_ledger_hash"),
                "decision_model_sha256": candidate_metrics.get("decision_model_sha256"),
                "decision_threshold_sha256": candidate_metrics.get("decision_threshold_sha256"),
                "decision_settlement_engine_sha256": candidate_metrics.get("decision_settlement_engine_sha256"),
                "decision_hash_bundle_sha256": candidate_metrics.get("decision_hash_bundle_sha256"),
                "roi_status": candidate_metrics.get("roi_status"),
                "roi_not_applicable_reason": candidate_metrics.get("roi_not_applicable_reason"),
                "calibration_local_support_purchase_violations": candidate_metrics.get("calibration_local_support_purchase_violations"),
                "calibration_local_support_all_failures_rejected": candidate_metrics.get("calibration_local_support_all_failures_rejected"),
                "calibrator_decision_hashes_present": candidate_metrics.get("calibrator_decision_hashes_present"),
                "calibrator_decision_hash_bundle_violations": candidate_metrics.get("calibrator_decision_hash_bundle_violations"),
                "calibrator_decision_event_binding_violations": candidate_metrics.get("calibrator_decision_event_binding_violations"),
                "calibrator_fixed_component_hash_violations": candidate_metrics.get("calibrator_fixed_component_hash_violations"),
                "calibrator_duplicate_decision_event_bindings": candidate_metrics.get("calibrator_duplicate_decision_event_bindings"),
                "calibration_learning_population_unique_races": (
                    candidate_metrics.get(
                        "calibration_learning_population_unique_races"
                    )
...
def _remote_backtest_report_summaries(
    remote_evaluations: dict[str, Any],
) -> list[dict[str, Any]]:
    rows: list[dict[str, Any]] = []
    jobs = (
    ...
    for job in jobs:
        ...
        if not kind.startswith("standardized_365d_"):
            continue
        result = job.get("result") or {}
        metrics = result.get("metrics") or {}
        ...
        rows.append(
            {
                **identity,
                ...
                "evaluation_scope": _evaluation_scope(Path(file_name), []),
                "feature_set": result.get("feature_set"),
                "include_odds": result.get("include_odds"),
                "evaluated_races": metrics.get("evaluated_races"),
                "entry_log_loss": _float_or_none(metrics.get("entry_log_loss")),
                "entry_brier": _float_or_none(metrics.get("entry_brier")),
                "winner_top1_accuracy": _float_or_none(
                    metrics.get("winner_top1_accuracy")
                ),
                "trifecta_top1_hit_rate": _float_or_none(
                    metrics.get("trifecta_top1_hit_rate")
                ),
                "trifecta_top5_hit_rate": _float_or_none(
                    metrics.get("trifecta_top5_hit_rate")
                ),
...
_MAX_DAYS = 3650
_DEFAULT_DAYS = 90
_DEFAULT_HISTORY_DAYS = _MAX_DAYS
_EQUIPMENT_DAYS = 90
_DEFAULT_LIMIT = 120
_MAX_LIMIT = 500
_HISTORY_PAGE_SIZE = 80
...
def archive_history(db_path: Path, query: dict[str, list[str]]) -> dict[str, Any]:
    ...
    limit = _bounded_int(_archive_one(query, "limit", str(_HISTORY_PAGE_SIZE)), _HISTORY_PAGE_SIZE, 1, 200)
...
def _recent_races(conn: sqlite3.Connection, where_sql: str, params: tuple[Any, ...], limit: int = _HISTORY_PAGE_SIZE, offset: int = 0) -> list[dict[str, Any]]:
    return _archive_rows(
        conn,
        f"""
        SELECT
...
def _read_remote_eval_status(path: Path) -> dict[str, Any]:
    ...
    return _hydrate_local_evaluation_jobs(payload, path)


_LOCAL_EVALUATION_METRICS = (
    "roi",
    "profit_yen",
    "stake_yen",
    "return_yen",
...
def _hydrate_local_evaluation_jobs(
    payload: dict[str, Any], status_path: Path
) -> dict[str, Any]:
    """Prefer migrated local artifacts over stale state from an old worker."""
    project_root = status_path.parent.parent
    jobs: list[dict[str, Any]] = []
    local_results = 0
    for source in payload.get("jobs") or []:
        job = dict(source)
        output = str(job.get("output") or "")
        output_path = project_root / output if output else None
        result = _local_evaluation_result(output_path) if output_path else None
    ...
    if local_results:
        if payload.get("error"):
            hydrated["source_error"] = payload.get("error")
            hydrated.pop("error", None)
        hydrated["status"] = "ローカル成果物で更新"
        hydrated["local_results"] = local_results
    return hydrated


def _local_evaluation_result(path: Path | None) -> dict[str, Any] | None:
    if path is None or not path.is_file():
        return None
    result: dict[str, Any] = {
        "file": str(path),
    ...
    try:
        ...
        return result
    if not isinstance(data, dict):
        result["error"] = "result is not an object"
        return result
    metrics = {
    ...
    if "ticket_roi_attribution" in data:
        result["ticket_roi_attribution"] = data.get("ticket_roi_attribution") or {}
    return result


def _shadow_roadmap_status(model_dir: Path) -> dict[str, Any]:
    paths = {
        "state": model_dir / "realtime_odds_shadow_t5_safe_candidate_state.json",
        "backtest": model_dir
        / "realtime_odds_shadow_t5_safe_candidate_backtest.json",
        "bankroll": model_dir
        / "bankroll_realtime_odds_shadow_t5_safe_candidate_ev120_p010_odds60_10000.json",
    }
    ...
    for key, path in paths.items():
        try:
            ...
            data = {}
        values[key] = data if isinstance(data, dict) else {}
    backtest = values["backtest"]
    bankroll = values["bankroll"]
    return {
        "available": bool(backtest),
        "generated_at": backtest.get("generated_at"),
        "evaluated_races": backtest.get("evaluated_races"),
        "entry_log_loss": backtest.get("entry_log_loss"),
        "winner_top1_accuracy": backtest.get("winner_top1_accuracy"),
        "trifecta_top5_hit_rate": backtest.get("trifecta_top5_hit_rate"),
        "bankroll_evaluated_races": bankroll.get("evaluated_races"),
...
def _quality_gates(model_dir: Path, remote_evaluations: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    remote_running = bool(remote_counts.get("実行中") or remote_counts.get("待機中"))
    remote_failed = bool(remote_counts.get("失敗") or remote_counts.get("未生成"))
    ...
    return [
        ...
        {
            "target": "Remote Eval",
            "status": "実行中" if remote_running else "要対応" if remote_failed else "完了" if remote_counts.get("完了") else str(remote_evaluations.get("status") or "未取得"),
            "evidence": remote_text,
            "next": "実行中ジョブの完了を回収する" if remote_running else "失敗/未生成ジョブを再実行または明示的に終了判定する" if remote_failed else "全ジョブ終端済み。成果物と比較レポートを維持する",
        },
    ]
...
def _roadmap_improvements(
    ...
    standardized_by_name = {
        str(row.get("name") or ""): row for row in standardized_jobs
    }
    ...
    best_standardized = max(
        ...
        key=lambda row: float(
            ((row.get("result") or {}).get("metrics") or {}).get("roi") or -1
        ),
        default=None,
    )
    best_standardized_metrics = (
        ((best_standardized or {}).get("result") or {}).get("metrics") or {}
    )
    standard_no_odds = next(
        (
            row
            for row in standardized_jobs
    ...
    standard_no_odds_metrics = (
        ((standard_no_odds or {}).get("result") or {}).get("metrics") or {}
    )
    temporal_no_bet = next(
        (row for row in remote_jobs if row.get("kind") == "bankroll_temporal_no_bet"),
        None,
    )
    temporal_status = str((temporal_no_bet or {}).get("status") or "未登録")
    temporal_completed, temporal_expected = _remote_job_fold_progress(
        temporal_no_bet or {}
    )
    temporal_expected = temporal_expected or 5
    temporal_metrics = (
    ...
    predictor_running = any(
        str(row.get("kind") or "") == "予測ループ"
        for row in (processes or [])
    )
    calibrated_jobs = [
        row
    ...
    for model_id in ("calibrated_linear", "calibrated_mlp"):
        standard = standardized_by_name.get(f"standardized_365d_v2_{model_id}") or {}
        if model_id not in calibrated_metrics and standard.get("status") == "完了":
            calibrated_metrics[model_id] = (
                ((standard.get("result") or {}).get("metrics") or {})
            )
    calibrated_complete = {
        "calibrated_linear",
        "calibrated_mlp",
    } <= calibrated_metrics.keys()
    ...
    listwise_search_job = next(
        (row for row in remote_jobs if row.get("kind") == "feature_teacher_search"),
        None,
    ) or standardized_by_name.get(
        "standardized_365d_v2_listwise_feature_teacher"
    )
    listwise_newton_job = next(
        (row for row in remote_jobs if row.get("kind") == "newton_listwise_bankroll"),
        None,
    ) or standardized_by_name.get("standardized_365d_v2_listwise_newton")
    ...
    return [
        {
            ...
            "status": "完了",
            "progress": 100,
            "item": "2026-07-19リアルタイム収集完全性監査",
            "next": "実開催16場192Rで出走表・結果・払戻・120通りoddsは192/192。締切60秒以内188R、予測190R。復元不能な芦屋1R締切前oddsと2Rのlive予測欠損を品質記録として維持する。",
        },
        {
            "id": "M2-2",
            "milestone": "M2",
        ...
        },
        {
            ...
            "next": "公開 /race/raceresult への修正後、7月20日滞留7Rを回収し、7月21日144Rも結果残0で完了。15分超の結果待ちは通常監視へ移管する。",
        },
        {
            "id": "M2-4",
            "milestone": "M2/M4",
        ...
        },
        {
            ...
            "status": (
                "完了"
                if standardized_complete >= standardized_expected
                else "評価中"
            ),
            "progress": min(
                100,
                int(standardized_complete * 100 / standardized_expected),
            ),
            ...
            "next": (
                ...
                f"{float(best_standardized_metrics.get('roi') or 0):.4f}・損益 "
                f"{int(best_standardized_metrics.get('profit_yen') or 0):,}円。"
                if standardized_complete >= standardized_expected
                else f"標準365日成果物 {standardized_complete}/{standardized_expected}件を回収中。"
            ),
        },
        {
            "id": "M5-1",
        ...
        },
        {
            ...
            "status": (
                "暫定評価済み/正式1,000R待ち"
                if shadow_evaluation.get("available")
                else "蓄積待ち"
                if readiness < 1.0
                else "評価開始待ち"
            ),
            "progress": min(
                ...
                max(
                    int(readiness * 100),
                    50 if shadow_evaluation.get("available") else 0,
                ),
            ),
            "item": "実オッズ履歴不足の扱い",
            "next": (
                f"T-5以前だけで暫定評価 {int(shadow_evaluation.get('evaluated_races') or 0):,}R、"
                f"LogLoss {float(shadow_evaluation.get('entry_log_loss') or 0):.4f}、"
                f"1着 {float(shadow_evaluation.get('winner_top1_accuracy') or 0) * 100:.2f}%、"
                f"3T5 {float(shadow_evaluation.get('trifecta_top5_hit_rate') or 0) * 100:.2f}%。"
                f"正式判定は対象 {eligible_races:,}/{target_races:,}R到達後。"
                if shadow_evaluation.get("available")
                else f"対象 {eligible_races:,}/{target_races:,}R。到達までは過去ログ中心評価を主判定にする。"
            ),
        },
        {
            "id": "M6-2",
        ...
        },
        {
            ...
            "progress": (
                ...
                else min(95, int(temporal_completed * 100 / temporal_expected))
            ),
            "item": "学習内選択temporal no-bet 5fold",
            "next": (
                f"5fold完了。ROI {float(temporal_metrics.get('roi') or 0):.4f}、"
                f"損益 {int(temporal_metrics.get('profit_yen') or 0):,}円、"
                f"購入券 {int(temporal_metrics.get('tickets') or 0):,}。収益ゲートで採否判定する。"
                if temporal_status == "完了"
                else f"チェックポイントからfold {temporal_completed}/{temporal_expected}を再開中。holdoutを見ず学習内calibrationだけでno-bet条件を選ぶ。"
            ),
        },
        {
            "id": "M6-10",
...
def _roadmap_milestones(
    ...
    best_standard_metrics = (
        ((best_standard or {}).get("result") or {}).get("metrics") or {}
    )
    temporal_no_bet = next(
        (row for row in jobs if row.get("kind") == "bankroll_temporal_no_bet"),
        None,
    )
    temporal_status = str((temporal_no_bet or {}).get("status") or "")
    ...
    m6_progress = (
        ...
        if standardized_complete and temporal_status in {"実行中", "待機中"}
        else 84
        if standardized_complete
        else 82
        if sanity_status == "完了"
    ...
    return [
        ...
        },
        {
            ...
            "status": (
                "評価完了/昇格候補"
                if standardized_complete and listwise_promoted
                else "評価完了/主系維持"
                if standardized_complete
        ...
        },
        {
            "id": "M7",
            "title": "v系ファイル整理",
            "status": "完了/運用監視" if source_clean else "要整理",
            "progress": 100 if source_clean else 75,
            "next": (
                "番号付き/vN package Python 0本、安定版入口への切替と旧joblib互換を全テストで維持する"
                if source_clean
                else f"番号付き/vN package Python {int(source_inventory.get('count') or 0)}本を安定名へ集約する"
            ),
        },
        {
            "id": "M8",
...
def _process_snapshots() -> list[dict[str, Any]]:
    patterns = [
        ...
        ("-m boatrace_ai.web.postgresql_dashboard", "Webサーバ"),
        ("realtime_predictor", "予測ループ"),
        ("realtime_collector", "リアルタイム収集"),
        ("-m boatrace_ai.runtime.collector", "リアルタイム収集"),
        ("-m boatrace_ai.runtime.postgresql_collector", "リアルタイム収集"),
        ("--predict", "予測ループ"),
...
def model_performance_audit_snapshot(
    ...
    for row in rows[:12]:
        audit = {
            ...
            for key in (
                ...
                "joint_product_identity_residual_mean",
                "joint_product_identity_residual_max_abs",
                "joint_product_identity_consistent",
                ...
                "decision_threshold_sha256",
                "decision_settlement_engine_sha256",
        ...
        protocol_id = str(audit.get("evaluation_protocol_id") or "旧成果物: 未記録")
        resampling_id = str(audit.get("bootstrap_condition_id") or "未記録")
        evaluation_t = (
        ...
        product_identity_support = (
            "合格"
            if audit.get("joint_product_identity_consistent") is True
            else "不整合"
            if audit.get("joint_product_identity_consistent") is False
            else "未記録"
        )
        covariance = audit.get("joint_covariance_mean")
        covariance_direction = (
            "減額" if covariance is not None and float(covariance) < 0.0
            else "加算" if covariance is not None and float(covariance) > 0.0
    ...
    if not rendered:
        rendered.append(
            '<tr><td colspan="12">結合資金評価の数値成果物なし</td></tr>'
        )
    model_rows = []
    general_rendered = []
