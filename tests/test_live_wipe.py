...
from boatrace_ai.web_dashboard import _latest_live_window_row


class LiveWipeTest(unittest.TestCase):
    def test_selects_latest_started_race_within_five_minutes(self) -> None:
        rows = [
            {"race_id": "old", "deadline_at": "2026-07-19T09:00:00+09:00"},
            {"race_id": "latest", "deadline_at": "2026-07-19T09:03:00+09:00"},
            {"race_id": "future", "deadline_at": "2026-07-19T09:05:00+09:00"},
        ]
    ...
    def test_stops_at_exactly_five_minutes(self) -> None:
        rows = [{"race_id": "race", "deadline_at": "2026-07-19T09:00:00+09:00"}]
        selected = _latest_live_window_row(
            rows,
            now=datetime.fromisoformat("2026-07-19T09:05:00+09:00"),
        )
